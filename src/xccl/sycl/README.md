...
> **Caveat:** `sycl_oneccl_pingpong`, `sycl_oneccl_halo_2d`, `sycl_oneccl_alltoall`, and
> `sycl_oneccl_cg_step` need oneCCL primitives the NCCL backend may not implement. The UNISA
