...
GPU_BENCH_MSG_SIZES=1,1024 GPU_BENCH_NTRIALS=1 tools/launch.sh allreduce cuda_mpi 1n4g
GPU_BENCH_ROUTINGS=uniform,hotspot80 GPU_BENCH_NTRIALS=1 tools/launch.sh moe cuda_mpi 1n4g
```
