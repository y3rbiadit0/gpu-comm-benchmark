...
export METIS_HOME=${METIS_HOME:-$HOME/opt/metis_nvhpc}
export METIS_DIR=${METIS_DIR:-$METIS_HOME}

export PATH="$NVHPC_CUDA/bin:$PATH"
export LD_LIBRARY_PATH="$METIS_HOME/lib64:$MATH_LIBS/lib:$NCCL_HOME/lib:$NVSHMEM_HOME/lib:${LD_LIBRARY_PATH:-}"
