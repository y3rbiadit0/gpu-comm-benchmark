#!/bin/bash -l
#SBATCH --job-name=moe_oshmpi_2n4g
...
GPU_BENCH_BINARY=${GPU_BENCH_BINARY:-$GPU_BENCH_PROJECT_ROOT/build/leonardo-oshmpi/src/shmem/oshmpi/oshmpi_moe}
GPU_BENCH_RESULT_NAME=${GPU_BENCH_RESULT_NAME:-moe-oshmpi-2n4g}
GPU_BENCH_NODES=2
