...
#SBATCH --job-name=moe_cuda_nvshmem_1n2g
...
CP_STACK=cuda
CP_RUNTIME=nvshmem
CP_BINARY=${CP_BINARY:-$CP_PROJECT_ROOT/build/leonardo-cuda-nvshmem/src/shmem/nvshmem/cuda_nvshmem_moe}
CP_RESULT_NAME=${CP_RESULT_NAME:-moe-cuda-nvshmem-1n2g}
CP_NODES=1
CP_TASKS_PER_NODE=2
