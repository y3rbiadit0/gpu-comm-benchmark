#!/bin/bash -l
#SBATCH --job-name=moe_sycl_mpi_1n1g
...
GPU_BENCH_BINARY=${GPU_BENCH_BINARY:-$GPU_BENCH_PROJECT_ROOT/build/leonardo-sycl-mpi/src/mpi/sycl/sycl_mpi_moe}
GPU_BENCH_RESULT_NAME=${GPU_BENCH_RESULT_NAME:-moe-sycl-mpi-1n1g}
GPU_BENCH_NODES=1
