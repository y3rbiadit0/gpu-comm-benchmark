#!/bin/bash -l
#SBATCH --job-name=moe_cuda_mpi_1n2g
...
CP_STACK=cuda
CP_RUNTIME=mpi-cuda
CP_BINARY=${CP_BINARY:-$CP_PROJECT_ROOT/build/leonardo-cuda-mpi/src/mpi/cuda/cuda_mpi_moe}
CP_RESULT_NAME=${CP_RESULT_NAME:-moe-cuda-mpi-1n2g}
CP_NODES=1
CP_TASKS_PER_NODE=2
