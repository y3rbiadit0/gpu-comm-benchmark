...
#SBATCH --job-name=vector_add_cuda_mpi_1n4g
...
CP_STACK=cuda
CP_RUNTIME=mpi-cuda
CP_BINARY=${CP_BINARY:-$CP_PROJECT_ROOT/build/leonardo-cuda-mpi/implementations/cuda_mpi/cuda_mpi_vector_add}
CP_RESULT_NAME=${CP_RESULT_NAME:-vector-add-cuda-mpi-1n4g}
CP_NODES=1
CP_TASKS_PER_NODE=4
