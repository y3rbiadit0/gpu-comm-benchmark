...
#SBATCH --job-name=vector_add_cuda_nccl_1n1g
...
CP_STACK=cuda
CP_RUNTIME=mpi-cuda
CP_BINARY=${CP_BINARY:-$CP_PROJECT_ROOT/build/leonardo-cuda-nccl/implementations/cuda_nccl/cuda_nccl_vector_add}
CP_RESULT_NAME=${CP_RESULT_NAME:-vector-add-cuda-nccl-1n1g}
CP_NODES=1
CP_TASKS_PER_NODE=1
