...
#SBATCH --job-name=vector_add_sycl_oneccl_1n4g
...
CP_BINARY=${CP_BINARY:-$CP_PROJECT_ROOT/build/leonardo-sycl-oneccl/implementations/sycl_oneccl/sycl_oneccl_vector_add}
CP_RESULT_NAME=${CP_RESULT_NAME:-vector-add-sycl-oneccl-1n4g}
CP_NODES=1
CP_TASKS_PER_NODE=4
