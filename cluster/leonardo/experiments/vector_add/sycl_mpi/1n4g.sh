...
#SBATCH --job-name=vector_add_sycl_mpi_1n4g
...
CP_STACK=sycl
CP_RUNTIME=sycl-mpi
CP_BINARY=${CP_BINARY:-$CP_PROJECT_ROOT/build/leonardo-sycl-mpi/src/mpi/sycl/sycl_mpi_vector_add}
CP_RESULT_NAME=${CP_RESULT_NAME:-vector-add-sycl-mpi-1n4g}
CP_NODES=1
CP_TASKS_PER_NODE=4
