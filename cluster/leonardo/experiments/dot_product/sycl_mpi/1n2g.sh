...
#SBATCH --job-name=dot_product_sycl_mpi_1n2g
...
CP_STACK=sycl
CP_RUNTIME=sycl-mpi
CP_BINARY=${CP_BINARY:-$CP_PROJECT_ROOT/build/leonardo-sycl-mpi/src/mpi/sycl/sycl_mpi_dot_product}
CP_RESULT_NAME=${CP_RESULT_NAME:-dot-product-sycl-mpi-1n2g}
CP_NODES=1
CP_TASKS_PER_NODE=2
