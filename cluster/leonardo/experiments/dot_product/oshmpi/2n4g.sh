...
#SBATCH --job-name=dot_product_oshmpi_2n4g
...
CP_STACK=cuda
CP_RUNTIME=oshmpi
CP_BINARY=${CP_BINARY:-$CP_PROJECT_ROOT/build/leonardo-oshmpi/src/shmem/oshmpi/oshmpi_dot_product}
CP_RESULT_NAME=${CP_RESULT_NAME:-dot-product-oshmpi-2n4g}
CP_NODES=2
CP_TASKS_PER_NODE=4
