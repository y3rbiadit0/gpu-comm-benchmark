...
#SBATCH --job-name=dot_product_cuda_nccl_2n1g
...
CP_STACK=cuda
CP_RUNTIME=mpi-cuda
CP_BINARY=${CP_BINARY:-$CP_PROJECT_ROOT/build/leonardo-cuda-nccl/src/xccl/cuda/cuda_nccl_dot_product}
CP_RESULT_NAME=${CP_RESULT_NAME:-dot-product-cuda-nccl-2n1g}
CP_NODES=2
CP_TASKS_PER_NODE=1
