...
#SBATCH --job-name=dot_product_cuda_mpi_2n1g
...
CP_STACK=cuda
CP_RUNTIME=mpi-cuda
CP_BINARY=${CP_BINARY:-$CP_PROJECT_ROOT/build/leonardo-cuda-mpi/src/mpi/cuda/cuda_mpi_dot_product}
CP_RESULT_NAME=${CP_RESULT_NAME:-dot-product-cuda-mpi-2n1g}
CP_NODES=2
CP_TASKS_PER_NODE=1
