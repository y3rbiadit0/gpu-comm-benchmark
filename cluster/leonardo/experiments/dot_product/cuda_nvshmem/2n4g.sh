...
#SBATCH --job-name=dot_product_cuda_nvshmem_2n4g
...
CP_STACK=cuda
CP_RUNTIME=nvshmem
CP_BINARY=${CP_BINARY:-$CP_PROJECT_ROOT/build/leonardo-cuda-nvshmem/src/shmem/nvshmem/cuda_nvshmem_dot_product}
CP_RESULT_NAME=${CP_RESULT_NAME:-dot-product-cuda-nvshmem-2n4g}
CP_NODES=2
CP_TASKS_PER_NODE=4
