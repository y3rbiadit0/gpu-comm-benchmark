#!/bin/bash -l
#SBATCH --job-name=cg_step_cuda_nccl_1n2g
...
CP_STACK=cuda
CP_RUNTIME=mpi-cuda
CP_BINARY=${CP_BINARY:-$CP_PROJECT_ROOT/build/leonardo-cuda-nccl/src/xccl/cuda/cuda_nccl_cg_step}
CP_RESULT_NAME=${CP_RESULT_NAME:-cg-step-cuda-nccl-1n2g}
CP_NODES=1
CP_TASKS_PER_NODE=2
