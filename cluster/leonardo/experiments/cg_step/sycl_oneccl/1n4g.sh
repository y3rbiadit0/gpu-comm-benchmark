...
CP_BINARY=${CP_BINARY:-$CP_PROJECT_ROOT/build/leonardo-sycl-oneccl/src/xccl/sycl/sycl_oneccl_cg_step}
CP_RESULT_NAME=${CP_RESULT_NAME:-cg-step-sycl-oneccl-1n4g}
CP_NODES=1
CP_TASKS_PER_NODE=4
CP_LAUNCHER=mpirun
