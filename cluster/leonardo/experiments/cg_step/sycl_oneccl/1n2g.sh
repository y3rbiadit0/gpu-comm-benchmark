#!/bin/bash -l
#SBATCH --job-name=cg_step_sycl_oneccl_1n2g
...
GPU_BENCH_BINARY=${GPU_BENCH_BINARY:-$GPU_BENCH_PROJECT_ROOT/build/leonardo-sycl-oneccl/src/xccl/sycl/sycl_oneccl_cg_step}
GPU_BENCH_RESULT_NAME=${GPU_BENCH_RESULT_NAME:-cg-step-sycl-oneccl-1n2g}
GPU_BENCH_NODES=1
