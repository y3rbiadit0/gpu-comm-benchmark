#!/bin/bash -l
#SBATCH --job-name=cg_step_cuda_mpi_8n4g
...
GPU_BENCH_BINARY=${GPU_BENCH_BINARY:-$GPU_BENCH_PROJECT_ROOT/build/leonardo-cuda-mpi/src/mpi/cuda/cuda_mpi_cg_step}
GPU_BENCH_RESULT_NAME=${GPU_BENCH_RESULT_NAME:-cg-step-cuda-mpi-8n4g}
GPU_BENCH_NODES=8
