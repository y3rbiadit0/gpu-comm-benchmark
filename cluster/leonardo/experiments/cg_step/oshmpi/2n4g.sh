#!/bin/bash -l
#SBATCH --job-name=cg_step_oshmpi_2n4g
...
GPU_BENCH_BINARY=${GPU_BENCH_BINARY:-$GPU_BENCH_PROJECT_ROOT/build/leonardo-oshmpi/src/shmem/oshmpi/oshmpi_cg_step}
GPU_BENCH_RESULT_NAME=${GPU_BENCH_RESULT_NAME:-cg-step-oshmpi-2n4g}
GPU_BENCH_NODES=2
