#!/bin/bash -l
#SBATCH --job-name=allreduce_cuda_mpi_1n2g
...
GPU_BENCH_BINARY=${GPU_BENCH_BINARY:-$GPU_BENCH_PROJECT_ROOT/build/leonardo-cuda-mpi/src/mpi/cuda/cuda_mpi_allreduce}
GPU_BENCH_RESULT_NAME=${GPU_BENCH_RESULT_NAME:-allreduce-cuda-mpi-1n2g}
GPU_BENCH_NODES=1
