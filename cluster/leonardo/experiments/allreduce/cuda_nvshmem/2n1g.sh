...
#SBATCH --job-name=allreduce_cuda_nvshmem_2n1g
...
CP_STACK=cuda
CP_RUNTIME=nvshmem
CP_BINARY=${CP_BINARY:-$CP_PROJECT_ROOT/build/leonardo-cuda-nvshmem/src/shmem/nvshmem/cuda_nvshmem_allreduce}
CP_RESULT_NAME=${CP_RESULT_NAME:-allreduce-cuda-nvshmem-2n1g}
CP_NODES=2
CP_TASKS_PER_NODE=1
