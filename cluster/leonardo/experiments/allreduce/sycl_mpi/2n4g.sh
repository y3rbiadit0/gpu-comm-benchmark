#!/bin/bash -l
#SBATCH --job-name=allreduce_sycl_mpi_2n4g
...
GPU_BENCH_BINARY=${GPU_BENCH_BINARY:-$GPU_BENCH_PROJECT_ROOT/build/leonardo-sycl-mpi/src/mpi/sycl/sycl_mpi_allreduce}
GPU_BENCH_RESULT_NAME=${GPU_BENCH_RESULT_NAME:-allreduce-sycl-mpi-2n4g}
GPU_BENCH_NODES=2
