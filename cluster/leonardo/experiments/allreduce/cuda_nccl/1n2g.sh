#!/bin/bash -l
#SBATCH --job-name=allreduce_cuda_nccl_1n2g
...
GPU_BENCH_BINARY=${GPU_BENCH_BINARY:-$GPU_BENCH_PROJECT_ROOT/build/leonardo-cuda-nccl/src/xccl/cuda/cuda_nccl_allreduce}
GPU_BENCH_RESULT_NAME=${GPU_BENCH_RESULT_NAME:-allreduce-cuda-nccl-1n2g}
GPU_BENCH_NODES=1
