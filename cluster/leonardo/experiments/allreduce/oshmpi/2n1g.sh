#!/bin/bash -l
#SBATCH --job-name=allreduce_oshmpi_2n1g
...
GPU_BENCH_BINARY=${GPU_BENCH_BINARY:-$GPU_BENCH_PROJECT_ROOT/build/leonardo-oshmpi/src/shmem/oshmpi/oshmpi_allreduce}
GPU_BENCH_RESULT_NAME=${GPU_BENCH_RESULT_NAME:-allreduce-oshmpi-2n1g}
GPU_BENCH_NODES=2
