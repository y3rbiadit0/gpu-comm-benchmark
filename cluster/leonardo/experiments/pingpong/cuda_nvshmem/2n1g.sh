#!/bin/bash -l
#SBATCH --job-name=pingpong_cuda_nvshmem_2n1g
...
GPU_BENCH_BINARY=${GPU_BENCH_BINARY:-$GPU_BENCH_PROJECT_ROOT/build/leonardo-cuda-nvshmem/src/shmem/nvshmem/cuda_nvshmem_pingpong}
GPU_BENCH_RESULT_NAME=${GPU_BENCH_RESULT_NAME:-pingpong-cuda-nvshmem-2n1g}
GPU_BENCH_NODES=2
