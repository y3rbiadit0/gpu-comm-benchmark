#!/bin/bash -l
#SBATCH --job-name=pingpong_oshmpi_1n2g
...
GPU_BENCH_BINARY=${GPU_BENCH_BINARY:-$GPU_BENCH_PROJECT_ROOT/build/leonardo-oshmpi/src/shmem/oshmpi/oshmpi_pingpong}
GPU_BENCH_RESULT_NAME=${GPU_BENCH_RESULT_NAME:-pingpong-oshmpi-1n2g}
GPU_BENCH_NODES=1
