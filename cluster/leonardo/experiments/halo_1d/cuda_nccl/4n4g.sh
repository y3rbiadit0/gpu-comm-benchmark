#!/bin/bash -l
#SBATCH --job-name=halo_1d_cuda_nccl_4n4g
...
GPU_BENCH_BINARY=${GPU_BENCH_BINARY:-$GPU_BENCH_PROJECT_ROOT/build/leonardo-cuda-nccl/src/xccl/cuda/cuda_nccl_halo_1d}
GPU_BENCH_RESULT_NAME=${GPU_BENCH_RESULT_NAME:-halo-1d-cuda-nccl-4n4g}
GPU_BENCH_NODES=4
