...
#SBATCH --job-name=halo_1d_cuda_nvshmem_iter_1n1g
...
CP_STACK=cuda
CP_RUNTIME=nvshmem
CP_BINARY=${CP_BINARY:-$CP_PROJECT_ROOT/build/leonardo-cuda-nvshmem/implementations/cuda_nvshmem/cuda_nvshmem_halo_1d_iter}
CP_RESULT_NAME=${CP_RESULT_NAME:-halo-1d-cuda-nvshmem-iter-1n1g}
