...
#SBATCH --job-name=halo_1d_cuda_mpi_cuda_aware_iter_1n4g
...
CP_STACK=cuda
CP_RUNTIME=mpi-cuda
CP_BINARY=${CP_BINARY:-$CP_PROJECT_ROOT/build/leonardo-cuda-mpi/src/mpi/cuda/cuda_mpi_halo_1d_cuda_aware_iter}
CP_RESULT_NAME=${CP_RESULT_NAME:-halo-1d-cuda-mpi-cuda-aware-iter-1n4g}
