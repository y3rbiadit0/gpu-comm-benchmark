...
GPU_BENCH_N=17 GPU_BENCH_NTRIALS=1 cluster/leonardo/launch.sh halo_1d cuda_mpi 1n4g
GPU_BENCH_N=17 GPU_BENCH_NTRIALS=1 cluster/leonardo/launch.sh halo_1d cuda_mpi 2n1g
GPU_BENCH_N=17 GPU_BENCH_NTRIALS=1 cluster/leonardo/launch.sh halo_1d cuda_mpi 2n4g
```
...
```bash
GPU_BENCH_PROFILE=nsys GPU_BENCH_NTRIALS=1 cluster/leonardo/launch.sh halo_1d cuda_nvshmem 2n4g
```
