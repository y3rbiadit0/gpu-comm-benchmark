#!/bin/bash -l
#SBATCH --job-name=halo_1d_oshmpi_1n2g
...
GPU_BENCH_BINARY=${GPU_BENCH_BINARY:-$GPU_BENCH_PROJECT_ROOT/build/leonardo-oshmpi/src/shmem/oshmpi/oshmpi_halo_1d}
GPU_BENCH_RESULT_NAME=${GPU_BENCH_RESULT_NAME:-halo-1d-oshmpi-1n2g}
GPU_BENCH_NODES=1
