...
#SBATCH --job-name=halo_1d_cuda_nvshmem_2n4g
...
CP_STACK=cuda
CP_RUNTIME=nvshmem
CP_BINARY=${CP_BINARY:-$CP_PROJECT_ROOT/build/leonardo-cuda-nvshmem/implementations/cuda_nvshmem/cuda_nvshmem_halo_1d}
CP_RESULT_NAME=${CP_RESULT_NAME:-halo-1d-cuda-nvshmem-2n4g}
CP_NODES=2
CP_TASKS_PER_NODE=4
