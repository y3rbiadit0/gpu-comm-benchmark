...
CP_STACK=cuda
CP_RUNTIME=mpi-cuda
CP_BINARY=${CP_BINARY:-$CP_PROJECT_ROOT/build/leonardo-cuda-mpi/implementations/cuda_mpi/cuda_mpi_halo_1d}
CP_RESULT_NAME=${CP_RESULT_NAME:-halo-1d-cuda-mpi-2n4g}
CP_NODES=2
CP_TASKS_PER_NODE=4
