#!/bin/bash -l
#SBATCH --job-name=halo_1d_cuda_mpi_8n4g
...
GPU_BENCH_BINARY=${GPU_BENCH_BINARY:-$GPU_BENCH_PROJECT_ROOT/build/leonardo-cuda-mpi/src/mpi/cuda/cuda_mpi_halo_1d}
GPU_BENCH_RESULT_NAME=${GPU_BENCH_RESULT_NAME:-halo-1d-cuda-mpi-8n4g}
GPU_BENCH_NODES=8
