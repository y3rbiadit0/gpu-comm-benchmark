...
CP_STACK=sycl
CP_RUNTIME=mpi-cuda
CP_BINARY=${CP_BINARY:-$CP_PROJECT_ROOT/build/leonardo-sycl-mpi/implementations/sycl_mpi/sycl_mpi_halo_1d}
CP_RESULT_NAME=${CP_RESULT_NAME:-halo-1d-sycl-mpi-2n4g}
CP_NODES=2
CP_TASKS_PER_NODE=4
