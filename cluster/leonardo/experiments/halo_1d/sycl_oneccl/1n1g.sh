...
#SBATCH --job-name=halo_1d_sycl_oneccl_1n1g
...
CP_BINARY=${CP_BINARY:-$CP_PROJECT_ROOT/build/leonardo-sycl-oneccl/implementations/sycl_oneccl/sycl_oneccl_halo_1d}
CP_RESULT_NAME=${CP_RESULT_NAME:-halo-1d-sycl-oneccl-1n1g}
CP_NODES=1
CP_TASKS_PER_NODE=1
CP_LAUNCHER=mpirun
