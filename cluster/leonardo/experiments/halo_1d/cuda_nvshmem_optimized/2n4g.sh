#!/bin/bash -l
#SBATCH --job-name=halo_1d_cuda_nvshmem_optimized_2n4g
...
GPU_BENCH_BINARY=${GPU_BENCH_BINARY:-$GPU_BENCH_PROJECT_ROOT/build/leonardo-cuda-nvshmem/src/shmem/nvshmem/cuda_nvshmem_halo_1d_optimized}
GPU_BENCH_RESULT_NAME=${GPU_BENCH_RESULT_NAME:-halo-1d-cuda-nvshmem-optimized-2n4g}
GPU_BENCH_NODES=2
