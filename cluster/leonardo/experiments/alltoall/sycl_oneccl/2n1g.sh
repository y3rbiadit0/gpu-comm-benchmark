...
CP_BINARY=${CP_BINARY:-$CP_PROJECT_ROOT/build/leonardo-sycl-oneccl/src/xccl/sycl/sycl_oneccl_alltoall}
CP_RESULT_NAME=${CP_RESULT_NAME:-alltoall-sycl-oneccl-2n1g}
CP_NODES=2
CP_TASKS_PER_NODE=1
CP_LAUNCHER=mpirun
