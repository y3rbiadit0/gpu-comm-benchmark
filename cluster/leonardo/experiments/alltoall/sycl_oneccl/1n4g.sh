#!/bin/bash -l
#SBATCH --job-name=alltoall_sycl_oneccl_1n4g
...
GPU_BENCH_BINARY=${GPU_BENCH_BINARY:-$GPU_BENCH_PROJECT_ROOT/build/leonardo-sycl-oneccl/src/xccl/sycl/sycl_oneccl_alltoall}
GPU_BENCH_RESULT_NAME=${GPU_BENCH_RESULT_NAME:-alltoall-sycl-oneccl-1n4g}
GPU_BENCH_NODES=1
