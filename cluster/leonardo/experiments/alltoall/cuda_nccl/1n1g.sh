#!/bin/bash -l
#SBATCH --job-name=alltoall_cuda_nccl_1n1g
...
GPU_BENCH_BINARY=${GPU_BENCH_BINARY:-$GPU_BENCH_PROJECT_ROOT/build/leonardo-cuda-nccl/src/xccl/cuda/cuda_nccl_alltoall}
GPU_BENCH_RESULT_NAME=${GPU_BENCH_RESULT_NAME:-alltoall-cuda-nccl-1n1g}
GPU_BENCH_NODES=1
