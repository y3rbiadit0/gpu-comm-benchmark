#!/bin/bash -l
#SBATCH --job-name=alltoall_cuda_mpi_1n4g
...
CP_STACK=cuda
CP_RUNTIME=mpi-cuda
CP_BINARY=${CP_BINARY:-$CP_PROJECT_ROOT/build/leonardo-cuda-mpi/src/mpi/cuda/cuda_mpi_alltoall}
CP_RESULT_NAME=${CP_RESULT_NAME:-alltoall-cuda-mpi-1n4g}
CP_NODES=1
CP_TASKS_PER_NODE=4
