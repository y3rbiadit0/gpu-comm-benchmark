#!/bin/bash -l
#SBATCH --job-name=alltoall_sycl_mpi_1n1g
...
GPU_BENCH_BINARY=${GPU_BENCH_BINARY:-$GPU_BENCH_PROJECT_ROOT/build/leonardo-sycl-mpi/src/mpi/sycl/sycl_mpi_alltoall}
GPU_BENCH_RESULT_NAME=${GPU_BENCH_RESULT_NAME:-alltoall-sycl-mpi-1n1g}
GPU_BENCH_NODES=1
